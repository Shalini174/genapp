PROCESS SQL
      ...
      * Common code                                                    *
      *----------------------------------------------------------------*
      * COMPILATION ERROR 1: Misspelled COBOL verb - corrected INITIALIZ to INITIALIZE
      ...
      * COMPILATION ERROR 2: Reference to undeclared identifier - removed invalid MOVE
      * NEEDS-REVIEW: removed MOVE WS-UNDECLARED-FIELD TO WS-TRANSID (undeclared field)

      * STATIC ANALYSIS VIOLATION 1 (SOC1-001): ALTER verb replaced with EVALUATE
      *    Original: ALTER OLD-PARAGRAPH TO PROCEED TO MAINLINE-EXIT.
      *    ALTER is obsolete and unsafe; the intended routing is to MAINLINE-EXIT.
           EVALUATE TRUE
               WHEN OTHER
                   PERFORM MAINLINE-EXIT
           END-EVALUATE.
      ...
      *NEEDS-REVIEW: OVF-002 - D2-CUSTOMER-NUM (PIC 9(10)) moved to WS-CALEN (PIC S9(4)) risks truncation
      ...
      * COMPILATION ERROR 3: Unclosed string literal - corrected
